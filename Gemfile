...
gem 'gctools', require: false, platform: :mri_20

begin
  gem 'stackprof', require: false, platform: [:mri_20, :mri_22, :mri_23]
  gem 'memory_profiler', require: false, platform: [:mri_20, :mri_22, :mri_23]
  ...
  begin
    ...
    gem 'stackprof', require: false, platform: [:mri_20, :mri_22]
    gem 'memory_profiler', require: false, platform: [:mri_20, :mri_22]
  rescue Bundler::GemfileError
     gem 'stackprof', require: false, platform: [:mri_20]
     gem 'memory_profiler', require: false, platform: [:mri_20]
  end
end
